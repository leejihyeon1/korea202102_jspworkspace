...
<%
	//답변 등록에 필요한 team,step,depth를 받자
...
<table id="box" align="center" width="603" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>	
		<td id="list"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr id="title">
            ...
            <td><input type="hidden" name="reboard_id"></td>
          </tr>
          <tr id="writer">
  ...
  <tr>
	...
	<a href="/reboard/list.jsp"><img src="/reboard/images/list_btn.gif" width="61" height="20"></a>	</td>
  </tr>
  <tr>
    <td height="1" bgcolor="#CCCCCC"></td>
  </tr>
