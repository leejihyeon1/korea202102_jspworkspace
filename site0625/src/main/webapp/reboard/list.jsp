		...
		<td colspan="5" id="list">
		  ...
		  <%for(ReBoard reboard:boardList){ %>
		    <tr align="center" height="20px" onMouseOver="this.style.background='#FFFF99'" onMouseOut="this.style.background=''">
			  <td width="50"><%=reboard.getReboard_id() %></td>
			  <td width="303" style="text-align:left">
			  
			  <%if(reboard.getDepth()>0){ %>
			  	<img src="/reboard/images/re.png" width="20px" style="margin-left:<%=reboard.getDepth()*10%>px">
			  <%} %>
			  <a href="/reboard/detail.jsp?reboard_id=<%=reboard.getReboard_id()%>"><%=reboard.getTitle() %></a></td>
