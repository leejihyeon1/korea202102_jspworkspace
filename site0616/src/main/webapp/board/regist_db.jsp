...
<%
	...
	//내장 객체의 형태로 요청객체와 응답객체가 전달된다
	//내장 객체란? 개발자가 생성한 것이 아닌, 이미 시스템 즉 톰켓과 같은 웹컨테이너에서 지정해 놓은
	//내장된 javaEE의 객체들을 의미
	request.setCharacterEncoding("utf-8");//파라미터 받기 전 파라미터에 대한 인코딩
	...
	out.print(title+"<br>");//서블릿에서의 response 객체로부터 얻을 수 있는 인수
	out.print(writer+"<br>");
